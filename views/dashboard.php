    ...
    <div class="container">
        ...
        <?php if ($_SESSION['tipo'] === 'administrador'): ?>
            <div class="menu">
                ...
                <a href="admin_periodos_inscripcion.php" class="menu-item">
                    <strong>Gestión de Períodos de Inscripción</strong><br>
                    <small>Definir fechas de apertura y cierre para inscripciones</small>
                </a>
